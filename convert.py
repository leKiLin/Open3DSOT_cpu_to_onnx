...
points = torch.randn(1, 10000, 5)
candidate_bc = torch.randn(1, 10000, 9)

input_dict = {
    "points": points,
    "candidate_bc": candidate_bc,
}

torch.onnx.export(net, input_dict, "test.onnx", opset_version=11)#, verbose=True)